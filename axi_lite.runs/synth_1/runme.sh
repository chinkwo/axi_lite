...
HD_PWD='F:/FPGA_SOC/axi_lite/axi_lite/axi_lite.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_lite_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_lite_wrapper.tcl
