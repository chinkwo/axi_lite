...
HD_PWD='F:/FPGA_SOC/axi_lite/axi_lite/axi_lite.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_lite_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source axi_lite_wrapper.tcl -notrace
